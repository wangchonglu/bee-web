...
define(function (require, exports, module) {
    ...
    var actions = {
        //获取合同签发列表
        getApplyList: function (page,length,flag,callback,errorcall) {
            var url = foundSettings.api.getApplyList;
            var reqData = {
        ...
        //添加企业通讯录
        AddInfo: function (name,deptId, phone,email, callback,errorcall) {
        ...
        //删除企业通讯录
        AuthApply: function (phoneId,uid, callback,errorcall) {
            var url = foundSettings.api.authEmployee;
            var reqData = {
                token: foundSettings.loginUser.token,
                phone: phoneId,
                uid:uid
